...
namespace Modulo3.Controllers
{
    public class MamiferosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Patas,NombreCientifico,EcoLocalizacion")] Mamifero mamifero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Patas,NombreCientifico,EcoLocalizacion")] Mamifero mamifero)
        {
            if (id != mamifero.Id)
            {
                return NotFound();
